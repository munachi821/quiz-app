...
//fetching a random question based on the selected category
...
const highlightCorrectAnswer = () => {
    ...
    const iconHTML = `<span class="fas fa-check-circle"></span>`
...
const handleAnswer = (option, answerIndex) => {
    ...
    const iconHTML = `<span class="fas fa-${isCorrect ? 'check-circle' : 'times-circle'}"></span>`
...
//Reset the quiz ans return to the configuration container
const resetQuiz = () => {
    resetTimer();
